...
This Nginx image is used to act as a reverse proxy as sidecar container on an AWS ECS application. It implements IP based rate limiting and hardening against basic attacks.
